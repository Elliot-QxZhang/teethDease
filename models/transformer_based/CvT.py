...
class CvT(nn.Module):
    def __init__(self, image_size, in_channels, num_classes, dim=64, kernels=[7, 3, 3], strides=[4, 2, 2],
        ...
        self.pool = pool
        self.dim = dim
        # self.conv_embed = nn.Conv2d(in_channels=in_channels, out_channels=64, kernel_size=7, stride=4, padding=2)
        ##### Stage 1 #######
...
CvT_13 = CvT(224, 3, 2, depth=[1, 2, 10])
CvT_21 = CvT(224, 3, 2, depth=[1, 4, 16])
CvT_w24 = CvT(224, 3, 2, dim=192, depth=[2, 2, 20])
