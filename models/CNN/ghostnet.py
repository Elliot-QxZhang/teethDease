...
batch_size = 256
train_data = MyDataset('/kaggle/input/myhandwrite/train-img/train-img/train-kaggle.txt')  # 获取训练数据集
test_data = MyDataset('/kaggle/input/myhandwrite/test-img/test-img/test-kaggle.txt')
